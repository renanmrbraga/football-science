...
from app.components.cards.contratacoes_com_custo_card import render_contratacoes_com_custo_card
from app.components.cards.total_contratacoes_card import render_total_contratacoes_card
from app.components.cards.ticket_medio_com_custo_card import render_ticket_medio_com_custo_card
from app.components.charts.top_gastos_chart import render_top_gastos_chart
from app.components.charts.gastos_por_ano_chart import render_gastos_por_ano_chart
from app.components.maps.transferencias_map import render_mapa_transferencias_chart
