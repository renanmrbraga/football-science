...
# Definir caminhos a partir do .env
clubes_file = os.getenv("ARQUIVO_CLUBES")
transferencias_file = os.getenv("ARQUIVO_TRANSFERENCIAS_RAW")
output_file = os.getenv("ARQUIVO_TRANSFERENCIAS_PROCESSED")
