# app/components/cards/aproveitamento_card.py
import streamlit as st
from utils.formatters import format_percent
from constants.theme import get_theme_styles

def render_aproveitamento_card(valor: float) -> None:
    theme = get_theme_styles()
    valor_formatado = format_percent(valor)
    ...
    st.markdown(
        ...
        <div style="{card_style}">
            <h4 style="{title_style}">Aproveitamento</h4>
