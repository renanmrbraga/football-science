# app/components/cards/contratacoes_com_custo_card.py
import streamlit as st
from utils.formatters import format_int
from constants.theme import get_theme_styles

def render_contratacoes_com_custo_card(valor: int) -> None:
    ...
    st.markdown(
        ...
        <div style="{card_style}">
            <h4 style="{title_style}">Contratações - Com Custo</h4>
